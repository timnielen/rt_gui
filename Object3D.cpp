...
void Object3D::updateTranformationMatrix() {
...
void Object3D::setRotationAxis(glm::vec3 r) {
	axis = r;
	updateTranformationMatrix();
}
void Object3D::setRotationAngle(float a) {
	angle = a;
	updateTranformationMatrix();
}
...
void Object3D::render(const Shader &shader) {
